...
const SignUpPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 sm:px-6 lg:px-8">
      ...
      >
        <div className="bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10 w-full">
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm w-full">
                ...
                <input
                  ...
                  className="block w-full px-4 py-3 pl-10 bg-gray-700 border border-gray-600 rounded-md shadow-sm
