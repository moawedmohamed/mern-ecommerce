...
const stripePromise:Promise<Stripe|null>=loadStripe ('pk_test_51SQEFVEOY7WftrhMgpb4G7yFJsd3HRBRLdUARSnTrJppWQddXHLmJ5N6KyJ5xxys7hbWtMBNmuh4Juhx9CWkS0il001b0xxL4S');
const OrderSummary = () => {
