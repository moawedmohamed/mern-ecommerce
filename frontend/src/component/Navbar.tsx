  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 border-b border-emerald-800">
      <div className="container mx-auto px-6 py-3 flex items-center justify-between">
        ...
        {/* Right - Buttons + Home + Cart */}
        <div className="flex items-center gap-4">
          {/* Home */}
          <Link
            to={"/"}
            className="text-gray-300 hover:text-emerald-400 transition duration-300 ease-in-out text-lg font-medium"
          >
            Home
          </Link>
          ...
          {user && (
            <Link
              to={"/cart"}
              className="relative group text-gray-300 hover:text-emerald-400 transition duration-300 ease-in-out text-lg font-medium"
            >
              <ShoppingCart
